...
class ScenarioThreeController extends Controller
{
    ...
    public function fetchLastDetail(Request $request)
    {
        ...
        $lastDetail = LogXMLGenActivity::where('xml_type', $scenarioType)->where('xml_gen_status',1)->where('scenario_no',3)
            ->orderBy('id', 'desc')
            ->first();
    ...
    public function generate_xml()
    {
        ...
        // ScenarioThree::whereBetween('date_transaction', [$from_date, $to_date])
