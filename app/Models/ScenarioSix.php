...
class ScenarioSix extends Model
{
    use HasFactory;

    protected $table = 'scenario_6_trans_details';
    ...
    protected $fillable = [
        ...
        'to_account_signatory_gender',
        'to_account_signatory_title',
        'to_account_signatory_first_name',
        'to_account_signatory_last_name',
        'to_account_signatory_birthdate',
        'to_account_signatory_ssn',
        'to_account_signatory_nationality1',
        'to_account_signatory_residence',
        'to_account_signatory_address_type',
        'to_account_signatory_address',
        'to_account_signatory_city',
        'to_account_signatory_country_code',
        'to_account_signatory_occupation',
        'to_account_signatory_role',
        'status',
        'is_delete',
        'xml_gen_status',
        'created_at',
