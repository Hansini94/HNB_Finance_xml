...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('scenario_4_trans_details', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('to_account_director_passport_number');
            $table->char('to_account_director_passport_country', 2); // CHAR(2)
            ...
            $table->char('to_person_signatory_gender', 1); // CHAR(1)
            $table->char('to_person_signatory_title', 4); // CHAR(4)
            $table->string('to_person_signatory_first_name');
            $table->string('to_person_signatory_last_name');
            $table->timestamp('to_person_signatory_birthdate');
            $table->string('to_person_signatory_ssn');
            $table->string('to_person_signatory_passport_number');
            $table->char('to_person_signatory_passport_country', 2); // CHAR(2)
            $table->char('to_person_signatory_nationality1', 2); // CHAR(2)
            $table->char('to_person_signatory_residence', 2); // CHAR(2)
            $table->char('to_person_signatory_address_type', 4); //
            $table->string('to_person_signatory_address');
            $table->string('to_person_signatory_city');
            $table->string('to_person_signatory_country_code');
            $table->string('to_person_signatory_occupation');
            $table->string('to_person_signatory_role');             
            $table->char('status', 1);
    ...
    {
        Schema::dropIfExists('scenario_4_trans_details');
    }
};
