...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('scenario_5_trans_details', function (Blueprint $table) {
            $table->id();
            ...
            $table->char('from_account_incorporation_country_code', 2); // CHAR(2)
            ...
            $table->string('from_account_director_passport_number');
            $table->char('from_account_director_passport_country', 2); // CHAR(2)
    ...
    {
        Schema::dropIfExists('scenario_5_trans_details');
    }
};
