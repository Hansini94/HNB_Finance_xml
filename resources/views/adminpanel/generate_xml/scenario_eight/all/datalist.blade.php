            ...
            <section id="widget-grid" class="">
                ...
                <div class="row">
                    ...
                    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="jarviswidget jarviswidget-color-darken" id="scenario_eight" data-widget-editbutton="false">
                            <header>
                                <span class="widget-icon"> <i class="fa fa-table"></i> </span>
                                <h2>{{ __('Scenario Eight Transactions') }}</h2>
                            </header>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="row cms_top_btn_row" style="margin-left:auto;margin-right:auto;">
                                                ...
                                                <form action="{{ route('generate-old-xml-eight') }}" method="POST">
        ...
        <script type="text/javascript">
            $(function() {
                ...
                var table = $('.data-table').DataTable({
                    ...
                    ajax: {
                        url: "{{ url('scenario-eight-edit') }}/" + id, // Construct the AJAX URL with the id
                        type: 'GET'
                    },
                    columnDefs: [{
                            "defaultContent": "-",
                    ...
                    columns: [{
                        ...
                        {
                            data: 'blockscenarioeight',
                            name: 'blockscenarioeight',
                            orderable: false,
                            searchable: false
                        },
                    ],
            ...
            $('#scenario_eight').on('click', '.btn-delete', function(e) {
                ...
                swal({
                    ...
                    if (value == true) {
                        window.location.replace("blockscenarioeight/" + ent_id);
                    }
                });
            });
        </script>
