@section('title', 'Scenario Eight List')
<x-app-layout>
    <x-slot name="header">
        <style>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="row cms_top_btn_row" style="margin-left:auto;margin-right:auto;">
                        <a href="{{ route('scenario-eight-list') }}">
                            <button class="btn cms_top_btn top_btn_height ">{{ __('Generate XML') }}</button>
                        </a>

                        <a href="{{ route('scenario-eight-all-list') }}">
                            <button
            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false"
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                        <form action="{{ route('save-scenario-eight-all') }}" enctype="multipart/form-data"
                                ...
                                <ul id="myTab1" class="nav nav-tabs bordered">
                                    <li class="active" id="s1A">
                                        <a href="#s1" onclick="show_submit('T1')"
                                            data-toggle="tab">{{ __('Scenario 8 Details') }} </a>
                                    </li>
                                    <li id="s2B">
