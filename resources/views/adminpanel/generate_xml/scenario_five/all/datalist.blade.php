                    ...
                    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="jarviswidget jarviswidget-color-darken" id="scenario_five" data-widget-editbutton="false">
                            <header>
                                ...
                                <h2>{{ __('Scenario Five Transactions') }}</h2>
                            </header>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="row cms_top_btn_row" style="margin-left:auto;margin-right:auto;">
                                                ...
                                                <form action="{{ route('generate-old-xml-five') }}" method="POST">
        ...
        <script type="text/javascript">
            $(function() {
                ...
                var table = $('.data-table').DataTable({
                    ...
                    ajax: {
                        url: "{{ url('scenario-five-edit') }}/" + id, // Construct the AJAX URL with the id
                        type: 'GET'
                    },
                    columnDefs: [{
                            "defaultContent": "-",
                    ...
                    columns: [{
                        ...
                        {
                            data: 'blockscenariofive',
                            name: 'blockscenariofive',
                            orderable: false,
                            searchable: false
                        },
                    ],
            ...
            $('#scenario_five').on('click', '.btn-delete', function(e) {
                ...
                swal({
                    ...
                    if (value == true) {
                        window.location.replace("blockscenariofive/" + ent_id);
                    }
                });
            });
        </script>
