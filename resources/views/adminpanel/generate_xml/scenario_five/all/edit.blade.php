@section('title', 'Scenario Five List')
<x-app-layout>
    <x-slot name="header">
        <style>
        ...
        <div id="content">
            ...
            <div class="col-lg-12">
                    <div class="row cms_top_btn_row" style="margin-left:auto;margin-right:auto;">
                        <a href="{{ route('scenario-five-list') }}">
                            <button class="btn cms_top_btn top_btn_height ">{{ __('Generate XML') }}</button>
                        </a>

                        <a href="{{ route('scenario-five-all-list') }}">
            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" role="widget">
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                        <form action="{{ route('save-scenario-five-all') }}" enctype="multipart/form-data" method="post" id="scenario-form" class="smart-form">
                            @csrf
                            @method('PUT')
                            <div class="widget-body padding-10">
                                <ul id="myTab1" class="nav nav-tabs bordered">
                                    <li class="active" id="s1A">
                                        <a href="#s1" onclick="show_submit('T1')" data-toggle="tab">{{ __('Scenario 5 Details') }} </a>
                                    </li>
                                    <li id="s2B">
                                            ...
                                            <fieldset>
                                                <div class="row">
                                                    ...
                                                    <section class="col col-4">
                                                        ...
                                                        <section class="col col-4">
                                                        <label class="label">Account Name<span style=" color: red;">*</span></label>
                                                        <label class="input">
                                                            <input type="text" id="from_account_name" name="from_account_name" reuired value="{{ $data->from_account_name }}">
                                                        </label>
                                                        </section>
                                                        <div class="clearfix"></div>
                                                        <section class="col col-4">
                                                        ...
                                                        <label class="input">
                                                            <input type="text" id="from_account_incorporation_legal_form" name="from_account_incorporation_legal_form" required value="{{ $data->from_account_incorporation_legal_form }}">
                                                        </label>
                                                        </section>
                                                        <section class="col col-4">
                                                        <label class="label">Incorporation Number<span style=" color: red;">*</span></label>
                                                        <label class="input">
                                                            <input type="text" id="from_account_incorporation_number" name="from_account_incorporation_number" required value="{{ $data->from_account_incorporation_number }}">
                                                        </label>
                                                        </section>
                                                        <section class="col col-4">
                                                        <label class="label">Business<span style=" color: red;">*</span></label>
                                                        <label class="input">
                                                            <input type="text" id="from_account_business" name="to_account_business" required value="{{ $data->to_account_business }}">
                                                        </label>
                                                        </section>
                                                        <div class="clearfix"></div>
                                                        <section class="col col-4">
                                                        ...
                                                        <section class="col col-4">
                                                            ...
                                                            <label class="input">
                                                            <input type="text" id="from_account_address" name="from_account_address" required value="{{ $data->from_account_address }}">
                                                            </label>
                                                        </section>
                                                        <section class="col col-4">
                                                            <label class="label">City<span style=" color: red;">*</span></label>
                                                            <label class="input">
                                                            <input type="text" id="from_account_city" name="from_account_city" required value="{{ $data->from_account_city }}">
                                                            </label>
                                                        </section>
                                                        <div class="clearfix"></div>
                                                        <section class="col col-4">
                                                            ...
                                                            <label class="input">
                                                            <input type="text" id="from_account_country_code" name="from_account_country_code" required value="{{ $data->from_account_country_code }}">
                                                            </label>
                                                        </section>
                                                        <section class="col col-4">
