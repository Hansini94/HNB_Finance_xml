            ...
            <section id="widget-grid" class="">
                ...
                <div class="row">
                    ...
                    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="jarviswidget jarviswidget-color-darken" id="scenario_four" data-widget-editbutton="false">
                            <header>
                                <span class="widget-icon"> <i class="fa fa-table"></i> </span>
                                <h2>{{ __('Scenario Four Transactions') }}</h2>
                            </header>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="row cms_top_btn_row" style="margin-left:auto;margin-right:auto;">
                                                ...
                                                <form action="{{ route('generate-old-xml-four') }}" method="POST">
        ...
        <script type="text/javascript">
            $(function() {
                ...
                var table = $('.data-table').DataTable({
                    ...
                    ajax: {
                        url: "{{ url('scenario-four-edit') }}/" + id, // Construct the AJAX URL with the id
                        type: 'GET'
                    },
                    columnDefs: [{
                            "defaultContent": "-",
                    ...
                    columns: [{
                        ...
                        {
                            data: 'blockscenariofour',
                            name: 'blockscenariofour',
                            orderable: false,
                            searchable: false
                        },
                    ],
            ...
            $('#scenario_four').on('click', '.btn-delete', function(e) {
                ...
                swal({
                    ...
                    if (value == true) {
                        window.location.replace("blockscenariofour/" + ent_id);
                    }
                });
            });
        </script>
