@section('title', 'Scenario Seven List')
<x-app-layout>
    <x-slot name="header">
        <style>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="row cms_top_btn_row" style="margin-left:auto;margin-right:auto;">
                        <a href="{{ route('scenario-seven-list') }}">
                            <button class="btn cms_top_btn top_btn_height ">{{ __('Generate XML') }}</button>
                        </a>

                        <a href="{{ route('scenario-seven-all-list') }}">
                            <button
            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false"
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                        <form action="{{ route('save-scenario-seven-all') }}" enctype="multipart/form-data"
                                ...
                                <ul id="myTab1" class="nav nav-tabs bordered">
                                    <li class="active" id="s1A">
                                        <a href="#s1" onclick="show_submit('T1')"
                                            data-toggle="tab">{{ __('Scenario 7 Details') }} </a>
                                    </li>
                                    <li id="s2B">
                                        ...
                                        <div class="widget-body no-padding">
                                            <fieldset>
                                                <div class="row">
                                                    ...
                                                    <section class="col col-4">
                                                        <label class="label">Person Account Type</label>
                                                        <label class="input">
                                                            <input type="text"
                                                    ...
                                                    <section class="col col-4">
                                                        <label class="label">Commentsa</label>
                                                        <label class="input">
                                                            <input type="text" id="to_comments" name="to_comments"
                                                                value="{{ $data->to_comments }}">
                                                        </label>
                                                    </section>
                                                    <div class="clearfix"></div>
                                                    <section class="col col-4">
