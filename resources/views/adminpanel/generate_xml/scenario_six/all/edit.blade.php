            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" role="widget">
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                        <form action="{{ route('save-scenario-six-all') }}" enctype="multipart/form-data" method="post" id="scenario-form" class="smart-form">
                            @csrf
                            @method('PUT')
                            <div class="widget-body padding-10">
                                <ul id="myTab1" class="nav nav-tabs bordered">
                                    <li class="active" id="s1A">
                                        <a href="#s1" onclick="show_submit('T1')" data-toggle="tab">{{ __('Scenario 6 Details') }} </a>
                                    </li>
                                    <li id="s2B">
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <section class="col col-4">
                                                        ...
                                                        <label class="input">
                                                            <select id="to_account_signatory_gender" name="to_account_signatory_gender" class="select2" required>
                                                                <option value="F" {{ $data->to_account_signatory_gender == 'F' ? "selected" : "" }}>Female</option>
                                                                <option value="M" {{ $data->to_account_signatory_gender == 'M' ? "selected" : "" }}>Male</option>
                                                                <option value="O" {{ $data->to_account_signatory_gender == 'O' ? "selected" : "" }}>Other</option>
                                                            </select>
                                                        </label>
                                                    </section>
                                                    <section class="col col-4">
                                                        ...
                                                        <label class="input">
                                                            <select id="to_account_signatory_title" name="to_account_signatory_title" class="select2" >
                                                                <option value="Mr" {{ $data->to_account_signatory_title == 'Mr' ? "selected" : "" }}>Mr</option>
                                                                <option value="Ms" {{ $data->to_account_signatory_title == 'Ms' ? "selected" : "" }}>Ms</option>
                                                                <option value="Mrs" {{ $data->to_account_signatory_title == 'Mrs' ? "selected" : "" }}>Mrs</option>
                                                                <option value="Miss" {{ $data->to_account_signatory_title == 'Miss' ? "selected" : "" }}>Miss</option>
                                                                <option value="Dr" {{ $data->to_account_signatory_title == 'Dr' ? "selected" : "" }}>Dr</option>
                                                            </select>
                                                        </label>
                                                    </section>
                                                    <div class="clearfix"></div>
                                                    <section class="col col-4">
                                                        ...
                                                        <label class="input">
                                                        <input type="text" id="to_account_signatory_first_name" name="to_account_signatory_first_name" value="{{ $data->to_account_signatory_first_name }}">
                                                        </label>
                                                    </section>
                                                    <section class="col col-4">
                                                        <label class="label">Last Name</label>
                                                        <label class="input">
                                                        <input type="text" id="to_account_signatory_last_name" name="to_account_signatory_last_name" value="{{ $data->to_account_signatory_last_name }}">
                                                        </label>
                                                    </section>
                                                    <section class="col col-4">
                                                        <label class="label">Birthdate <span style=" color: red;">*</span></label>
                                                        <label class="input">
                                                        <input type="date" id="to_account_signatory_birthdate" name="to_account_signatory_birthdate" required value="{{ $data->to_account_signatory_birthdate }}">
                                                        </label>
                                                    </section>
                                                    <div class="clearfix"></div>
                                                    <section class="col col-4">
                                                        ...
                                                        <label class="input">
                                                        <input type="text" id="to_account_signatory_ssn" name="to_account_signatory_ssn" value="{{ $data->to_account_signatory_ssn }}">
                                                        </label>
                                                    </section>
                                                    <section class="col col-4">
                                                        <label class="label">Nationality</label>
                                                        <label class="input">
                                                        <input type="text" id="to_account_signatory_nationality1" name="to_account_signatory_nationality1" value="{{ $data->to_account_signatory_nationality1 }}">
                                                        </label>
                                                    </section>
                                                    <section class="col col-4">
                                                        <label class="label">Residence</label>
                                                        <label class="input">
                                                        <input type="text" id="to_account_signatory_residence" name="to_account_signatory_residence" value="{{ $data->to_account_signatory_residence }}">
                                                        </label>
                                                    </section>
                                                    <div class="clearfix"></div>
                                                    <section class="col col-4">
                                                        ...
                                                        <label class="input">
                                                        <input type="text" id="to_account_signatory_address_type" name="to_account_signatory_address_type" value="{{ $data->to_account_signatory_address_type }}">
                                                        </label>
                                                    </section>
                                                    <section class="col col-4">
                                                        <label class="label">Address</label>
                                                        <label class="input">
                                                        <input type="text" id="to_account_signatory_address" name="to_account_signatory_address" value="{{ $data->to_account_signatory_address }}">
                                                        </label>
                                                    </section>
                                                    <section class="col col-4">
                                                        <label class="label">City</label>
                                                        <label class="input">
                                                        <input type="text" id="to_account_signatory_city" name="to_account_signatory_city" value="{{ $data->to_account_signatory_city }}">
                                                        </label>
                                                    </section>
                                                    <div class="clearfix"></div>
                                                    <section class="col col-4">
                                                        ...
                                                        <label class="input">
                                                        <input type="text" id="to_account_signatory_country_code" name="to_account_signatory_country_code" value="{{ $data->to_account_signatory_country_code }}">
                                                        </label>
                                                    </section>
                                                    <section class="col col-4">
                                                        <label class="label">Occupation<span style=" color: red;">*</span></label>
                                                        <label class="input">
                                                        <input type="text" id="to_account_signatory_occupation" name="to_account_signatory_occupation" required value="{{ $data->to_account_signatory_occupation }}">
                                                        </label>
                                                    </section>
                                                    <section class="col col-4">
                                                        <label class="label">Role<span style=" color: red;">*</span></label>
                                                        <label class="input">
                                                        <input type="text" id="to_account_signatory_role" name="to_account_signatory_role" required value="{{ $data->to_account_signatory_role }}">
                                                        </label>
                                                    </section>
                                                    <div class="clearfix"></div>
                                                    <section class="col col-4">
