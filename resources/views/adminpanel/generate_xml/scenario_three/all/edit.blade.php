            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false"
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                        <form action="{{ route('save-scenario-three-all') }}" enctype="multipart/form-data"
                            method="post" id="scenario-form" class="smart-form">
                            @csrf
                            @method('PUT')
                                ...
                                <ul id="myTab1" class="nav nav-tabs bordered">
                                    <li class="active" id="s1A">
                                        <a href="#s1" onclick="show_submit('T1')"
                                            data-toggle="tab">{{ __('Scenario 3 Details') }} </a>
                                    </li>
                                    <li id="s2B">
                                    ...
                                    <li id="s4D">
                                        <a href="#s4" class="nextIV" onclick="show_submit('T4')"
                                            data-toggle="tab">{{ __('Signatory and To Person Details') }} </a>
                                    </li>
                                </ul>
                                            ...
                                            <fieldset>
                                                <div class="row">
                                                    <section class="col col-4">
                                                        ...
                                                        <label class="input">
                                                            <input type="text" id="from_account_institution_name"
                                                    ...
                                                    <section class="col col-4">
                                                        ...
                                                        <label class="input">
                                                            <input type="text" id="from_account_branch"
                                                                name="from_account_branch"
                                                                value="{{ $data->from_account_branch }}">
                                                        </label>
                                                    </section>
                                                    <section class="col col-4">
                                                    ...
                                                    <section class="col col-4">
                                                        ...
                                                        <label class="input">
                                                            <input type="text"
                                                                id="from_account_personal_account_type"
                                                                name="from_account_personal_account_type"
                                                                value="{{ $data->from_account_personal_account_type }}">
                                                        </label>
                                                    </section>
                                                    <section class="col col-4">
                                                        <label class="label">Name</label>
                                                        <label class="input">
                                                            <input type="text" id="from_account_name"
                                                                name="from_account_name"
                                                                value="{{ $data->from_account_name }}">
                                                        </label>
                                                    </section>
                                                    <section class="col col-4">
                                                        ...
                                                        <label class="input">
                                                            <input type="tel"
                                                                id="from_account_incorporation_legal_form"
                                                                name="from_account_incorporation_legal_form"
                                                                value="{{ $data->from_account_incorporation_legal_form }}">
                                                        </label>
                                                    </section>
                                                    <div class="clearfix"></div>
                                                    <section class="col col-4">
                                                        ...
                                                        <label class="input">
                                                            <input type="text"
                                                                id="from_account_incorporation_number"
                                                                name="from_account_incorporation_number"
                                                                value="{{ $data->from_account_incorporation_number }}">
                                                        </label>
                                                    </section>
                                                    <section class="col col-4">
                                                        <label class="label">Business</label>
                                                        <label class="input">
                                                            <input type="text" id="from_account_business"
                                                                name="from_account_business"
                                                                value="{{ $data->from_account_business }}">
                                                        </label>
                                                    </section>
                                                    <section class="col col-4">
                                                        <label class="label">Address Type <span
                                                                style=" color: red;">*</span></label>
                                                        <label class="input">
                                                            <input type="text" id="from_account_address_type"
                                                                name="from_account_address_type" required
                                                                value="{{ $data->from_account_address_type }}">
                                                        </label>
                                                    </section>
                                                    <div class="clearfix"></div>
                                                    <section class="col col-4">
                                                        ...
                                                        <label class="input">
                                                            <input type="text" id="from_account_address"
                                                                name="from_account_address"
                                                                value="{{ $data->from_account_address }}">
                                                        </label>
                                                    </section>
                                                    <section class="col col-4">
                                                        <label class="label">Address City</label>
                                                        <label class="input">
                                                            <input type="text" id="from_account_city"
                                                                name="from_account_city"
                                                                value="{{ $data->from_account_city }}">
                                                        </label>
                                                    </section>
                                                    <section class="col col-4">
                                                        <label class="label">Address Country Code</label>
                                                        <label class="input">
                                                            <input type="text" id="from_account_country_code"
                                                                name="from_account_country_code"
                                                                value="{{ $data->from_account_country_code }}">
                                                        </label>
                                                    </section>
                                                    <div class="clearfix"></div>
                                                    <section class="col col-4">
                                                        ...
                                                        <label class="input">
                                                            <input type="text"
                                                                id="from_account_incorporation_country_code"
                                                                name="from_account_incorporation_country_code"
                                                                value="{{ $data->from_account_incorporation_country_code }}">
                                                        </label>
                                                    </section>
                                                    @if (!empty($directors))
                                                    ...
                                                    @endif
                                                    <section class="col col-4">
                                                        <label class="label">From Account Status Code<span
                                                                style=" color: red;">*</span></label>
                                                        <label class="input">
                                                            <input type="text" id="from_account_status_code"
                                                                name="from_account_status_code" required
                                                                value="{{ $data->from_account_status_code }}">
                                                        </label>
                                                    </section>
                                                    <section class="col col-4">
