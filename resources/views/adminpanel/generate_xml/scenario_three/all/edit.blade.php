@section('title', 'Scenario Three List')
<x-app-layout>
    <x-slot name="header">
        <style>
        ...
        <div id="content">
            ...
            <div class="col-lg-12">
                    <div class="row cms_top_btn_row" style="margin-left:auto;margin-right:auto;">
                        <a href="{{ route('scenario-three-list') }}">
                            <button class="btn cms_top_btn top_btn_height ">{{ __('Generate XML') }}</button>
                        </a>

                        <a href="{{ route('scenario-three-all-list') }}">
            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" role="widget">
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                        <form action="{{ route('save-scenario-three-all') }}" enctype="multipart/form-data" method="post" id="scenario-form" class="smart-form">
                            @csrf
                            @method('PUT')
                            <div class="widget-body padding-10">
                                <ul id="myTab1" class="nav nav-tabs bordered">
                                    <li class="active" id="s1A">
                                        <a href="#s1" onclick="show_submit('T1')" data-toggle="tab">{{ __('Scenario 3 Details') }} </a>
                                    </li>
                                    <li id="s2B">
                                            ...
                                            <fieldset>
                                                <div class="row">
                                                    ...
                                                    <section class="col col-4">
                                                        ...
                                                        <label class="input">
                                                            <input type="text" id="from_account_name" name="from_account_name" value="{{ $data->from_account_name }}">
                                                        </label>
                                                    </section>
                                                    <section class="col col-4">
                                                    <label class="label">Incorporation Legal Form</label>
                                                    <label class="input">
                                                        <input type="tel" id="from_account_incorporation_legal_form" name="from_account_incorporation_legal_form" value="{{ $data->from_account_incorporation_legal_form }}">
                                                    </label>
                                                    </section>
                                                    <div class="clearfix"></div>
                                                    <section class="col col-4">
                                                    ...
                                                    <label class="input">
                                                        <input type="text" id="from_account_incorporation_number" name="from_account_incorporation_number" value="{{ $data->from_account_incorporation_number }}">
                                                    </label>
                                                    </section>
                                                    <section class="col col-4">
                                                    <label class="label">Business</label>
                                                    <label class="input">
                                                        <input type="text" id="from_account_business" name="from_account_business" value="{{ $data->from_account_business }}">
                                                    </label>
                                                    </section>
                                                    <label class="label">Address Type <span style=" color: red;">*</span></label>
                                                    <label class="input">
                                                        <input type="text" id="from_account_address_type" name="from_account_address_type" required value="{{ $data->from_account_address_type }}">
                                                    </label>
                                                    </section>
                                                    <div class="clearfix"></div>
                                                    <section class="col col-4">
                                                    ...
                                                    <label class="input">
                                                        <input type="text" id="from_account_address" name="from_account_address" value="{{ $data->from_account_address }}">
                                                    </label>
                                                    </section>
                                                    <div class="clearfix"></div>
                                                    <section class="col col-4">
                                                    ...
                                                    <label class="input">
                                                        <input type="text" id="from_account_city" name="from_account_city" value="{{ $data->from_account_city }}">
                                                    </label>
                                                    </section>
                                                    <section class="col col-4">
                                                    <label class="label">Address Country Code</label>
                                                    <label class="input">
                                                        <input type="text" id="from_account_country_code" name="from_account_country_code" value="{{ $data->from_account_country_code }}">
                                                    </label>
                                                    </section>
                                                    <div class="clearfix"></div>
                                                    <section class="col col-4">
                                                    ...
                                                    <label class="input">
                                                        <input type="text" id="from_account_incorporation_country_code" name="from_account_incorporation_country_code" value="{{ $data->from_account_incorporation_country_code }}">
                                                    </label>
                                                    </section>
                                                    <section class="col col-4">
                                            ...
                                            <fieldset>
                                                <div class="row">
                                                    ...
                                                    <section class="col col-4">
                                                        ...
                                                        <label class="input">
                                                        <input type="text" id="from_person_signatory_is_primary" name="from_person_signatory_is_primary" value="{{ $data->from_person_signatory_is_primary }}">
                                                        </label>
                                                    </section>
                                                    <section class="col col-4">
                                                        <label class="label">Gender</label>
                                                        <label class="input">
                                                            <select id="from_person_signatory_gender" name="from_person_signatory_gender" class="select2" required>
                                                                <option value="F" {{ $data->from_person_signatory_gender == 'F' ? "selected" : "" }}>Female</option>
                                                                <option value="M" {{ $data->from_person_signatory_gender == 'M' ? "selected" : "" }}>Male</option>
                                                                <option value="O" {{ $data->from_person_signatory_gender == 'O' ? "selected" : "" }}>Other</option>
                                                            </select>
                                                        </label>
                                                    </section>
                                                    <section class="col col-4">
                                                        ...
                                                        <label class="input">
                                                            <select id="from_person_signatory_title" name="from_person_signatory_title" class="select2" >
                                                                <option value="Mr" {{ $data->from_person_signatory_title == 'Mr' ? "selected" : "" }}>Mr</option>
                                                                <option value="Ms" {{ $data->from_person_signatory_title == 'Ms' ? "selected" : "" }}>Ms</option>
                                                                <option value="Mrs" {{ $data->from_person_signatory_title == 'Mrs' ? "selected" : "" }}>Mrs</option>
                                                                <option value="Miss" {{ $data->from_person_signatory_title == 'Miss' ? "selected" : "" }}>Miss</option>
                                                                <option value="Dr" {{ $data->from_person_signatory_title == 'Dr' ? "selected" : "" }}>Dr</option>
                                                            </select>
                                                        </label>
                                                    </section>
                                                    <div class="clearfix"></div>
                                                    <section class="col col-4">
                                                        ...
                                                        <label class="input">
                                                        <input type="text" id="from_person_signatory_first_name" name="from_person_signatory_first_name" value="{{ $data->from_person_signatory_first_name }}">
                                                        </label>
                                                    </section>
                                                    <section class="col col-4">
                                                        <label class="label">Last Name</label>
                                                        <label class="input">
                                                        <input type="text" id="from_person_signatory_last_name" name="from_person_signatory_last_name" value="{{ $data->from_person_signatory_last_name }}">
                                                        </label>
                                                    </section>
                                                    <section class="col col-4">
                                                        <label class="label">Birthdate <span style=" color: red;">*</span></label>
                                                        <label class="input">
                                                        <input type="date" id="from_person_signatory_birthdate" name="from_person_signatory_birthdate" required value="{{ $data->from_person_signatory_birthdate }}">
                                                        </label>
                                                    </section>
                                                    <div class="clearfix"></div>
                                                    <section class="col col-4">
                                                        ...
                                                        <label class="input">
                                                        <input type="text" id="from_person_signatory_ssn" name="from_person_signatory_ssn" value="{{ $data->from_person_signatory_ssn }}">
                                                        </label>
                                                    </section>
                                                    <section class="col col-4">
                                                        <label class="label">Nationality</label>
                                                        <label class="input">
                                                        <input type="text" id="from_person_signatory_nationality1" name="from_person_signatory_nationality1" value="{{ $data->from_person_signatory_nationality1 }}">
                                                        </label>
                                                    </section>
                                                    <section class="col col-4">
                                                        <label class="label">Residence</label>
                                                        <label class="input">
                                                        <input type="text" id="from_person_signatory_residence" name="from_person_signatory_residence" value="{{ $data->from_person_signatory_residence }}">
                                                        </label>
                                                    </section>
                                                    <div class="clearfix"></div>
                                                    <section class="col col-4">
                                                        ...
                                                        <label class="input">
                                                        <input type="text" id="from_person_signatory_address_type" name="from_person_signatory_address_type" value="{{ $data->from_person_signatory_address_type }}">
                                                        </label>
                                                    </section>
                                                    <section class="col col-4">
                                                        <label class="label">Address</label>
                                                        <label class="input">
                                                        <input type="text" id="from_person_signatory_address" name="from_person_signatory_address" value="{{ $data->from_person_signatory_address }}">
                                                        </label>
                                                    </section>
                                                    <section class="col col-4">
                                                        <label class="label">City</label>
                                                        <label class="input">
                                                        <input type="text" id="from_person_signatory_city" name="from_person_signatory_city" value="{{ $data->from_person_signatory_city }}">
                                                        </label>
                                                    </section>
                                                    <div class="clearfix"></div>
                                                    <section class="col col-4">
                                                        ...
                                                        <label class="input">
                                                        <input type="text" id="from_person_signatory_country_code" name="from_person_signatory_country_code" value="{{ $data->from_person_signatory_country_code }}">
                                                        </label>
                                                    </section>
                                                    <section class="col col-4">
                                                        <label class="label">Occupation<span style=" color: red;">*</span></label>
                                                        <label class="input">
                                                        <input type="text" id="from_person_signatory_occupation" name="from_person_signatory_occupation" required value="{{ $data->from_person_signatory_occupation }}">
                                                        </label>
                                                    </section>
                                                    <section class="col col-4">
                                                        <label class="label">Role<span style=" color: red;">*</span></label>
                                                        <label class="input">
                                                        <input type="text" id="from_person_signatory_role" name="from_person_signatory_role" required value="{{ $data->from_person_signatory_role }}">
                                                        </label>
                                                    </section>
                                                    <div class="clearfix"></div>
                                                    <section class="col col-4">
