                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="row cms_top_btn_row" style="margin-left:auto;margin-right:auto;">
                                                ...
                                                <form action="{{ route('generate-old-xml-two') }}" method="POST">
        ...
        <script type="text/javascript">
            $(function() {
                ...
                var table = $('.data-table').DataTable({
                    ...
                    ajax: {
                        url: "{{ url('scenario-two-edit') }}/" + id, // Construct the AJAX URL with the id
                        type: 'GET'
                    },
                    columnDefs: [{
                            "defaultContent": "-",
                    ...
                    columns: [{
                        ...
                        {
                            data: 'blockscenariotwo',
                            name: 'blockscenariotwo',
                            orderable: false,
                            searchable: false
                        },
                    ],
            ...
            $('#scenario_two').on('click', '.btn-delete', function(e) {
                ...
                swal({
                    ...
                    if (value == true) {
                        window.location.replace("blockscenariotwo/" + ent_id);
                    }
                });
            });
        </script>
