            ...
            <div class="col-lg-12">
                    <div class="row cms_top_btn_row" style="margin-left:auto;margin-right:auto;"> 
                        <a href="{{ route('complain-category') }}">
                            <button class="btn cms_top_btn top_btn_height cms_top_btn_active">{{ __('complaincategory.add_new') }}</button>
                        </a>
            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" role="widget">
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                        <form action="{{ route('new-category') }}" enctype="multipart/form-data" method="post" id="category-form" class="smart-form">
                            @csrf
                            <fieldset>
                                <div class="row">
                                    <section class="col col-6">
                                        ...
                                        <label class="input">
                                            <input type="text" id="category_name_en" name="category_name_en" required value="">
                                        </label>
                                    </section>
                                    <section class="col col-6">
                                        <label class="label">{{ __('complaincategory.category_name_si') }}<span style=" color: red;">*</span> </label>
                                        <label class="input">
                                            <input type="text" id="category_name_si" name="category_name_si" required value="">
                                        </label>
                                    </section>
                                </div>
                                ...
                                <div class="row">
                                    <section class="col col-6">
                                        ...
                                        <label class="input">
                                            <input type="text" id="category_name_ta" name="category_name_ta" required value="">
                                        </label>
                                    </section>
                                    ...
                                    <section class="col col-6">
                                        ...
                                        <label class="input">
                                            <input type="text" id="expiry_days" name="expiry_days" required value="" data-parsley-type="integer">
                                        </label>
                                    </section>
                                </div>
                                <div class="row">
                                    <section class="col col-6">
                                        ...
                                        <label class="input">
                                            <input type="text" id="category_prefix" name="category_prefix" required value="" data-parsley-maxlength="1">
                                        </label>
                                    </section>
                                    <section class="col col-6">
                                        <label class="label">{{ __('complaincategory.order') }} <span style=" color: red;">*</span> </label>
                                        <label class="input">
                                            <input type="text" id="order" name="order" required value="" data-parsley-type="integer">
                                        </label>
                                    </section>
                                </div>
                                <div class="row">
                                    ...
                                    <section class="col col-6">
                                        ...
                                        <label class="select">
                                            <select name="status" id="status">
                                                <option value="Y">{{ __('complaincategory.status_active') }}</option>
                                                <option value="N">{{ __('complaincategory.status_inactive') }}</option>
                                            </select>
                                            <i></i>
                                        </label>
                                    </section>
