            ...
            <div class="col-lg-12">
                    <div class="row cms_top_btn_row" style="margin-left:auto;margin-right:auto;">
                        ...
                        <a href="{{ route('complain-category-list') }}">
                            <button class="btn cms_top_btn top_btn_height cms_top_btn_active">{{ __('complaincategory.view_all') }}</button>
                        </a>
                    </div>
                </div>
                <!-- <div class="col-lg-8">
                    ...
                    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="jarviswidget jarviswidget-color-darken" id="user_types" data-widget-editbutton="false">
                            <header>
                                ...
                                <h2>{{ __('complaincategory.category_list') }}</h2>
                            </header>
                            <!-- widget div-->
                            <div>
                                <!-- widget edit box -->
                                ...
                                <div class="widget-body no-padding table-responsive">
                                    <table class="table table-bordered data-table" width="100%">
                                        <thead>
                                            <tr>
                                                <th>{{ __('complaincategory.category_no') }}</th>
                                                <th>{{ __('complaincategory.category_name_en') }}</th>
                                                <th>{{ __('complaincategory.category_name_si') }}</th>
                                                <th>{{ __('complaincategory.category_name_ta') }}</th>
                                                <th>{{ __('complaincategory.expiry_days') }}</th>
                                                <th>{{ __('complaincategory.order') }}</th>
                                                <th>{{ __('complaincategory.edit') }}</th>
                                                <th width="100px">{{ __('complaincategory.status') }}</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        </tbody>
        ...
        <script type="text/javascript">
            $(function() {
                ...
                var table = $('.data-table').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('complain-category-list') }}",
                    order: [ 1, 'asc' ],
                    columns: [{
                            data: 'DT_RowIndex',
                            name: 'id'
                        ...
                        {
                            data: 'category_name_si',
                            name: 'category_name_si'
                        },
                        {
                            data: 'category_name_ta',
