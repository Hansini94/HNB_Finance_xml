            ...
            <div class="col-lg-12">
                    <div class="row cms_top_btn_row" style="margin-left:auto;margin-right:auto;">
                        ...
                        <a href="{{ route('complain-status-list') }}">
                            <button class="btn cms_top_btn top_btn_height cms_top_btn_active">{{ __('complainstatus.view_all') }}</button>
                        </a>
                    </div>
                </div>
                <!-- <div class="col-lg-8">
                    <ul id="sparks" class="">
                        <ul id="sparks" class="">
                            ...
                            <li class="sparks-info sparks-info_active" style="border: 1px solid #c5c5c5; padding-right: 0px; padding: 22px 15px; min-width: auto;">
                                <a href="{{ route('complain-status-list') }}">
                                    <h5>{{ __('complainstatus.view_all') }}</h5>
                                </a>
                    ...
                    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="jarviswidget jarviswidget-color-darken" id="user_types" data-widget-editbutton="false">
                            <header>
                                ...
                                <h2>{{ __('complainstatus.status_list') }}</h2>
                            </header>
                            <!-- widget div-->
                            <div>
                                <!-- widget edit box -->
                                ...
                                <div class="widget-body no-padding table-responsive">
                                    <table class="table table-bordered data-table" width="100%">
                                        <thead>
                                            <tr>
                                                <th>{{ __('complainstatus.complain_status_no') }}</th>
                                                <th>{{ __('complainstatus.complain_status_en') }}</th>
                                                <th>{{ __('complainstatus.complain_status_sin') }}</th>
                                                <th>{{ __('complainstatus.complain_status_tamil') }}</th>
                                                <th>{{ __('complainstatus.edit') }}</th>
                                                <th width="100px">{{ __('complainstatus.status') }}</th>
                                                <th width="100px">{{ __('complainstatus.is_delete') }}</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        </tbody>
        ...
        <script type="text/javascript">
            $(function() {
                ...
                var table = $('.data-table').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('complain-status-list') }}",
                    order: [ 1, 'asc' ],
                    columns: [{
                            data: 'DT_RowIndex',
                            name: 'id'
                        ...
                        {
                            data: 'blockcomplainstatus',
                            name: 'blockcomplainstatus',
                            orderable: false,
                            searchable: false
                        },
                    ]
