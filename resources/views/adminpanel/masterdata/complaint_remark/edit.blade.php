            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" role="widget">
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                        <form action="{{ route('save-complaint-remark') }}" enctype="multipart/form-data" method="post" id="complaint-remark-form" class="smart-form">
                        @csrf
                        @method('PUT')
                            <fieldset>
                                <div class="row">
                                    <section class="col col-6">
                                        ...
                                        <label class="textarea">
                                            <textarea type="text" row="5" id="remark_en" name="remark_en" required >{{ $data->remark_en }}</textarea>
                                        </label>
                                    </section>
                                    <section class="col col-6">
                                        <label class="label">{{ __('complaintremark.complain_remark_sin') }}<span style=" color: red;">*</span> </label>
                                        <label class="textarea">
                                            <textarea type="text" row="5" id="remark_si" name="remark_si" required >{{ $data->remark_si }}</textarea>
                                        </label>
                                    </section>
                                </div>
                                <div class="row">
                                <section class="col col-6">
                                        ...
                                        <label class="textarea">
                                            <textarea type="text" row="5" id="remark_ta" name="remark_ta" required >{{ $data->remark_ta }}</textarea>
                                        </label>
                                    </section>
                                    <section class="col col-4">
                                        ...
                                        <label class="select">
                                            <select name="status" id="status">
                                                <option value="Y" {{ $data->status == 'Y' ? "selected" : "" }}>{{ __('complaintremark.status_active') }}</option>
                                                <option value="N" {{ $data->status == 'N' ? "selected" : ""  }}>{{ __('complaintremark.status_inactive') }}</option>
                                            </select>
                                            <i></i>
                                        </label>
                                    </section>
