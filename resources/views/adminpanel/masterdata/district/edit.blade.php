            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" role="widget">
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                        <form action="{{ route('save-district') }}" enctype="multipart/form-data" method="post" id="district-form" class="smart-form">
                        @csrf
                        @method('PUT')
                            <fieldset>
                                <div class="row">
                                    ...
                                    <section class="col col-4">
                                        ...
                                        <label class="input">
                                            <input type="text" id="district_name_en" name="district_name_en" required value="{{ $data->district_name_en }}">
                                        </label>
                                    </section>
                                    <section class="col col-4">
                                        <label class="label">{{ __('district.district_name_sin') }}<span style=" color: red;">*</span> </label>
                                        <label class="input">
                                            <input type="text" id="district_name_sin" name="district_name_sin" required value="{{ $data->district_name_sin }}">
                                        </label>
                                    </section>
                                </div>
                                <div class="row">
                                    <section class="col col-4">
                                        ...
                                        <label class="input">
                                            <input type="text" id="district_name_tamil" name="district_name_tamil" required value="{{ $data->district_name_tamil }}">
                                        </label>
                                    </section>
                                    <section class="col col-4">
                                        ...
                                        <label class="select">
                                            <select name="status" id="status">
                                                <option value="Y" {{ $data->status == 'Y' ? "selected" : "" }}>{{ __('district.status_active') }}</option>
                                                <option value="N" {{ $data->status == 'N' ? "selected" : ""  }}>{{ __('district.status_inactive') }}</option>
                                            </select>
                                            <i></i>
                                        </label>
                                    </section>
