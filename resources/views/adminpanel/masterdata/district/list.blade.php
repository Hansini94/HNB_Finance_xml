...
<x-app-layout>
            ...
            <div class="col-lg-12">
                    <div class="row cms_top_btn_row" style="margin-left:auto;margin-right:auto;">
                        <a href="{{ route('district') }}">
                            <button class="btn cms_top_btn top_btn_height ">{{ __('district.add_new') }}</button>
                        </a>

                        <a href="{{ route('district-list') }}">
                            <button class="btn cms_top_btn top_btn_height cms_top_btn_active">{{ __('district.district_list') }}</button>
                        </a>
                    </div>
                </div>
                <!-- <div class="col-lg-8">
                    <ul id="sparks" class="">
                        <ul id="sparks" class="">
                            ...
                            <li class="sparks-info" style="border: 1px solid #c5c5c5; padding-right: 0px; padding: 22px 15px; min-width: auto;">
                                <a href="{{ route('district-list') }}">
                                    <h5>{{ __('district.district_list') }}</h5>
                                </a>
                    ...
                    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="jarviswidget jarviswidget-color-darken" id="user_types" data-widget-editbutton="false">
                            <header>
                                ...
                                <h2>{{ __('district.district_list') }}</h2>
                            </header>
                            <!-- widget div-->
                            <div>
                                <!-- widget edit box -->
                                ...
                                <div class="widget-body no-padding table-responsive">
                                    <table class="table table-bordered data-table" width="100%" id="district-table">
                                        <thead>
                                            <tr>
                                                <th>{{ __('district.district_no') }}</th>
                                                <th>{{ __('district.district_name_en') }}</th>
                                                <th>{{ __('district.district_name_sin') }}</th>
                                                <th>{{ __('district.district_name_tamil') }}</th>
                                                <th>{{ __('district.province') }}</th>
                                                <th>{{ __('district.edit') }}</th>
                                                <th width="100px">{{ __('district.status') }}</th>
                                                <th width="100px">{{ __('district.is_delete') }}</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        </tbody>
    ...
    <x-slot name="script">
        ...
        <script type="text/javascript">
            $(function() {
                ...
                var table = $('.data-table').DataTable({
                    ...
                    columns: [{
                        ...
                        {
                            data: 'district_name_sin',
                            name: 'district_name_sin'
                        },
                        {
                            data: 'district_name_tamil',
                            name: 'district_name_tamil'
                        },
                        {
            ...
            $('#district-table').on('click', '.btn-delete', function(e) {
