            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" role="widget">
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                        <form action="{{ route('save-establishment-type') }}" enctype="multipart/form-data" method="post" id="establishment-type-form" class="smart-form">
                        @csrf
                        @method('PUT')
                            <fieldset>
                                <div class="row">
                                    <section class="col col-4">
                                        ...
                                        <label class="input">
                                            <input type="text" id="establishment_name_en" name="establishment_name_en" required value="{{ $data->establishment_name_en }}">
                                        </label>
                                    </section>
                                    <section class="col col-4">
                                        <label class="label">{{ __('establishmenttype.establishment_name_sin') }}<span style=" color: red;">*</span> </label>
                                        <label class="input">
                                            <input type="text" id="establishment_name_sin" name="establishment_name_sin" required value="{{ $data->establishment_name_sin }}">
                                        </label>
                                    </section>
                                    <section class="col col-4">
                                        <label class="label">{{ __('establishmenttype.establishment_name_tam') }}<span style=" color: red;">*</span> </label>
                                        <label class="input">
                                            <input type="text" id="establishment_name_tam" name="establishment_name_tam" required value="{{ $data->establishment_name_tam }}">
                                        </label>
                                    </section>
                                </div>
                                <div class="row">
                                    <section class="col col-4">
                                        ...
                                        <label class="input">
                                            <input type="number" id="order" name="order" required value="{{ $data->order }}" data-parsley-type="integer">
                                            <i></i>
                                        </label>
                                    </section>
                                    <section class="col col-4">
                                        ...
                                        <label class="select">
                                            <select name="status" id="status">
                                                <option value="Y" {{ $data->status == 'Y' ? "selected" : "" }}>{{ __('establishmenttype.status_active') }}</option>
                                                <option value="N" {{ $data->status == 'N' ? "selected" : ""  }}>{{ __('establishmenttype.status_inactive') }}</option>
                                            </select>
                                            <i></i>
                                        </label>
                                    </section>
