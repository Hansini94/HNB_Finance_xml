            ...
            <div class="col-lg-12">
                    <div class="row cms_top_btn_row" style="margin-left:auto;margin-right:auto;">
                        <a href="{{ route('mail-template') }}">
                            <button class="btn cms_top_btn top_btn_height cms_top_btn_active">{{ __('province.view_all') }}</button>
                        </a>
                    </div>
                </div>
                <!-- <div class="col-lg-8">
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding table-responsive">
                                    <table class="table table-bordered data-table" width="100%">
                                        <thead>
                                            <tr>
                                                <th>{{ __('mailtemplate.no') }}</th>
                                                {{-- <th>{{ __('mailtemplate.name') }}</th> --}}
                                                <th>{{ __('mailtemplate.category') }}</th>
                                                <th>{{ __('mailtemplate.subject') }}</th>
                                                <th>{{ __('mailtemplate.subject_sin') }}</th>
                                                <th>{{ __('mailtemplate.subject_tam') }}</th>
                                                <th>{{ __('mailtemplate.edit') }}</th>
                                                <th width="100px">{{ __('mailtemplate.activation') }}</th>
            ...
            $(function() {
                ...
                var table = $('.data-table').DataTable({
                    ...
                    columns: [{
                        ...
                        // {
                        //     data: 'mail_template_title',
                        //     name: 'mail_template_title'
                        // },
                        {
                            data: 'category',
                            name: 'category'
                        ...
                        {
                            data: 'mail_template_name_en',
                            name: 'mail_template_name_en'
                        },
                        {
                            data: 'mail_template_name_sin',
                            name: 'mail_template_name_sin'
                        },
                        {
                            data: 'mail_template_name_tam',
                            name: 'mail_template_name_tam'
                        },
                        {
                            data: 'edit',
                            name: 'edit',
                        ...
                        // {
                        //     data: 'blockmailtemplate',
                        //     name: 'blockmailtemplate',
                        //     orderable: false,
                        //     searchable: false
                        // },
                    ]
