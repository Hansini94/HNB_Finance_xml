        ...
        <div id="content">
            ...
            <div class="col-lg-12">
                    <div class="row cms_top_btn_row" style="margin-left:auto;margin-right:auto;"> 
                        <a href="{{ route('new-original-equipment-for-vehicles') }}">
                            <button class="btn cms_top_btn top_btn_height cms_top_btn_active">ADD NEW</button>
                        </a>

                        <a href="{{ route('original-equipment-for-vehicles-list') }}">
            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" role="widget">
                <header>
                    <h2>Original Equipment For Vehicles</h2>
                </header>
                <!-- widget div-->
                <div>
                    <!-- widget edit box -->
                    ...
                    <div class="widget-body no-padding">
                        <form action="{{ route('new-original-equipment-for-vehicles') }}" enctype="multipart/form-data" method="post" id="store_details_form" class="smart-form">
                            @csrf
                            <fieldset>
                                <div class="row ">
                                    <section class="col col-6">
                                        <label class="label">Original Equipment For Vehicles Name <span style=" color: red;">*</span> </label>
...
//            },
            name: {
                required: "Please enter Original Equipment For Vehicles name",
            },
            status: {
                required: "Please select Original Equipment For Vehicles status",
