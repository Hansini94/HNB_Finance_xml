            ...
            <div class="col-lg-12">
                    <div class="row cms_top_btn_row" style="margin-left:auto;margin-right:auto;"> 
                        <a href="{{ route('province') }}">
                            <button class="btn cms_top_btn top_btn_height cms_top_btn_active">{{ __('province.add_new') }}</button>
                        </a>
            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" role="widget">
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                        <form action="{{ route('new-province') }}" enctype="multipart/form-data" method="post" id="province-form" class="smart-form">
                            @csrf
                            <fieldset>
                                <div class="row">
                                    <section class="col col-4">
                                        ...
                                        <label class="input">
                                            <input type="text" id="province_name_en" name="province_name_en" required value="">
                                        </label>
                                    </section>
                                    <section class="col col-4">
                                        <label class="label">{{ __('province.province_name_sin') }}<span style=" color: red;">*</span> </label>
                                        <label class="input">
                                            <input type="text" id="province_name_sin" name="province_name_sin" required value="">
                                        </label>
                                    </section>
                                    <section class="col col-4">
                                        <label class="label">{{ __('province.province_name_tamil') }}<span style=" color: red;">*</span> </label>
                                        <label class="input">
                                            <input type="text" id="province_name_tamil" name="province_name_tamil" required value="">
                                        </label>
                                    </section>
                                </div>
                                <div class="row">
                                    <section class="col col-4">
                                        ...
                                        <label class="select">
                                            <select name="status" id="status">
                                                <option value="Y">{{ __('province.status_active') }}</option>
                                                <option value="N">{{ __('province.status_inactive') }}</option>
                                            </select>
                                            <i></i>
                                        </label>
                                    </section>
