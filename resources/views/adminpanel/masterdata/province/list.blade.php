...
<x-app-layout>
                    ...
                    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="jarviswidget jarviswidget-color-darken" id="user_types" data-widget-editbutton="false">
                            <header>
                                ...
                                <h2>{{ __('province.province_list') }}</h2>
                            </header>
                            <!-- widget div-->
                            <div>
                                <!-- widget edit box -->
                                ...
                                <div class="widget-body no-padding table-responsive">
                                    <table class="table table-bordered data-table" width="100%" id="province-table">
                                        <thead>
                                            <tr>
                                                <th>{{ __('province.province_no') }}</th>
                                                <th>{{ __('province.province_name_en') }}</th>
                                                <th>{{ __('province.province_name_sin') }}</th>
                                                <th>{{ __('province.province_name_tamil') }}</th>
                                                <th>{{ __('province.edit') }}</th>
                                                <th width="100px">{{ __('province.status') }}</th>
                                                <th width="100px">{{ __('province.is_delete') }}</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        </tbody>
    ...
    <x-slot name="script">
        ...
        <script type="text/javascript">
            $(function() {
                ...
                var table = $('.data-table').DataTable({
                    ...
                    columns: [{
                        ...
                        {
                            data: 'province_name_sin',
                            name: 'province_name_sin'
                        },
                        {
                            data: 'province_name_tamil',
                            name: 'province_name_tamil'
                        },
                        {
                            data: 'edit',
                            name: 'edit',
            ...
            $('#province-table').on('click', '.btn-delete', function(e) {
