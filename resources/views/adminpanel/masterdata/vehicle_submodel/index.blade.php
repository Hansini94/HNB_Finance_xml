...
@php
    ...
    $brandID= $info[0]->brandID;
    $modelID= $info[0]->modelID;
    }
    @endphp
<x-app-layout>
    <x-slot name="header">
            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" role="widget">
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                        <form action="{{ route('new-vehiclesubmodel') }}" enctype="multipart/form-data" method="post" id="store_details_form" class="smart-form">
                            @csrf
                            <fieldset>
                                <div class="row ">

                                    <section class="col col-6">
                                        <label class="label">Vehicle Make <span style=" color: red;">*</span></label>
                                        <label class="select inp-holder">
                                            <select name="brandID" id="brandID" required="">
                                                <option value="" ></option>
                                                @foreach($brand as $row)

                                                <option value="{{  $row->id }}" @if($row->id== $brandID)selected="selected" @endif >{{ $row->name }}</option>
                                ...
                                <div class="row " id="brand_div">
                                    ...
                                    <section class="col col-6">
                                        <label class="label">Vehicle Model <span style=" color: red;">*</span></label>
                                            ...
                                            <select name="modelID" id="modelID" required="">
                                                ...
                                                <option value="{{  $row->id }}" @if($row->id== $modelID)selected="selected" @endif >{{ $row->name }}</option>
                                ...
                                <div class="row ">
                                    <section class="col col-6">
                                        <label class="label">Vehicle Submodel Name <span style=" color: red;">*</span> </label>
...
//            },
            name: {
                required: "Please enter vehicle submodel name",
            },
            status: {
                required: "Please select vehicle submodel status",
        ...
        $(document).on('change', '#brandID', function (e) {
                ...
                success: function(response){
                    ...
                    var dropdown = ' <section class="col col-6"> <label class="label">Vehicle Model <span style=" color: red;">*</span></label><label class="select inp-holder"><div class="existing_brand"> <select name="modelID" id="modelID" required=""> <option value="" ></option>';
                    if(len > 0){
