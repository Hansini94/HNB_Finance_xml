<nav x-data="{ open: false }" class="">
    ...
    <header id="header">
        <div id="logo-group">
            ...
            <h1 class="hidden-xs" style="font-weight: 900; color: #3b2c46; font-size: 18px; padding-top: 16px; padding-left: 10px;"><img src="{{ asset('public/back/img/logo.png') }}" alt="Brembo Managment System" style="position: relative; top: -10px; width: 150px; float: left; padding-right: 12px;"> </h1>
