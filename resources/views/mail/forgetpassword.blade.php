                  ...
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      ...
                      <td>
                        ...
                        <h2 style="text-align: center; text-transform: uppercase; color: #000000; margin-bottom: 15px;"><b>RESET YOUR PASSWORD</b></h2>
                        ...
                        <div style="width: 520px; float: left; text-align: left;">
                            ...
                            <div style="text-align: center; padding-bottom: 20px;">
                              <a href="{{ url('workshop/reset-password/'.$token) }}" class="main_btn">Reset Password</a>
                            </div> 
